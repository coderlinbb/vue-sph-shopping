      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            ...
            <input :value="cart.skuNum" @change="handler('change',$event.target.value*1,cart)" autocomplete="off" type="text" minnum="1" class="itxt" />
...
export default {
  ...
  methods: {
    ...
    deleteCartById(cart) {
      try {
        this.$store.dispatch('deleteCartListSkuId', cart.skuId)
        this.getData()
      } catch (error) {
        alert(error.message)
      }
